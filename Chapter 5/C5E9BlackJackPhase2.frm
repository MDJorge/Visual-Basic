...
'DATE:   April 13, 2014
'DESC:   C5 Ex 9 BlackJack PHASE II

Option Explicit

Dim intUserCard1, intUserCard2, intUserCard3, intUserCard4, intUserCard5, intCompCard1, intCompCard2, intCompCard3, intCompCard4, intCompCard5, intUserTotal, intCompTotal, ctrHits, ctrComp As Integer

Private Sub btnCheckScore_Click()
    Do While intUserTotal < 21 And intCompTotal < 21 And ctrComp < 4
        ctrComp = ctrComp + 1
        If ctrComp = 1 Then
        ...
        ElseIf ctrComp = 2 Then
            intCompCard4 = Int(10 * Rnd() + 1)
            lblCompCard4 = intCompCard4
            intCompTotal = intCompCard1 + intCompCard2 + intCompCard3 + intCompCard4
            lblCompScore = intCompTotal
        Else
            intCompCard5 = Int(10 * Rnd() + 1)
            lblCompCard5 = intUserCard5
            intCompTotal = intCompCard1 + intCompCard2 + intCompCard3 + intCompCard4 + intCompCard5
            lblPlayScore = intCompTotal
        End If
    Loop
...
Private Sub btnDrawCard_Click()
    ...
    ElseIf ctrHits = 2 Then
        intUserCard4 = Int(10 * Rnd() + 1)
        lblPlayCard4 = intUserCard4
        intUserTotal = intUserCard1 + intUserCard2 + intUserCard3 + intUserCard4
        lblPlayScore = intUserTotal
    ElseIf ctrHits = 3 Then
        intUserCard5 = Int(10 * Rnd() + 1)
        lblPlayCard5 = intUserCard5
        intUserTotal = intUserCard1 + intUserCard2 + intUserCard3 + intUserCard4 + intUserCard5
        lblPlayScore = intUserTotal
    Else
        btnDrawCard.Enabled = False
